...
func TestSyncService(t *testing.T) {
	// make sure etcd is in sync first
	if !test.IsETCD() {
		return
	}
	...
	t.Run("register microservice", func(t *testing.T) {
		t.Run("register a microservice named sync_micro_service will create a task should pass", func(t *testing.T) {
			resp, err := disco.RegisterService(microServiceGetContext(), &pb.CreateServiceRequest{
				Service: &pb.MicroService{
		...
		t.Run("register a microservice named AAA will not create a task should pass", func(t *testing.T) {
			resp, err := disco.RegisterService(microServiceGetContext(), &pb.CreateServiceRequest{
				Service: &pb.MicroService{
					AppId:       "sync_micro_service_group",
					ServiceName: "AAA",
	...
	t.Run("update micro-service", func(t *testing.T) {
		t.Run("update a microservice named sync_micro_service setting sync-test property will create a task should pass", func(t *testing.T) {
			request := &pb.UpdateServicePropsRequest{
				ServiceId:  serviceID,
				Properties: make(map[string]string),
			}
			request.Properties["sync-test"] = "sync-test"
			err := disco.PutServiceProperties(microServiceGetContext(), request)
			assert.NoError(t, err)
		...
		t.Run("update a microservice named AAA setting sync-test property will not create a task should pass", func(t *testing.T) {
			request := &pb.UpdateServicePropsRequest{
	...
	t.Run("unregister micro-service", func(t *testing.T) {
		t.Run("unregister a microservice named sync_micro_service will create a task and a tombstone should pass", func(t *testing.T) {
			err := disco.UnregisterService(microServiceGetContext(), &pb.DeleteServiceRequest{
				ServiceId: serviceID,
				Force:     true,
			})
			assert.NoError(t, err)
			...
			tombstones, err := tombstone.List(microServiceGetContext(), &tombstoneListReq)
			assert.NoError(t, err)
		...
		t.Run("unregister a microservice named AAA will not create a task and a tombstone should pass", func(t *testing.T) {
			err := disco.UnregisterService(microServiceGetContext(), &pb.DeleteServiceRequest{
				ServiceId: serviceIDNotInWhiteList,
				Force:     true,
			})
