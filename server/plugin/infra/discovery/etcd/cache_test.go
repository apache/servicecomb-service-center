...
func TestNullCache_Name(t *testing.T) {
	...
	NullCache.ForEach(func(k string, v *discovery.KeyValue) (next bool) {
		t.Fatalf("TestNullCache_Name failed")
		return false
	})
	NullCache.Remove("")
...
func TestKvCache_Get(t *testing.T) {
	c := NewKvCache("test", discovery.Configure())
	c.Put("", &discovery.KeyValue{Version: 1})
	c.Put("/", &discovery.KeyValue{Version: 1})
	c.Put("/a/b/c/d/e/1", &discovery.KeyValue{Version: 1})
	c.Put("/a/b/c/d/e/2", &discovery.KeyValue{Version: 2})
	c.Put("/a/b/d/d/f/3", &discovery.KeyValue{Version: 3})
	c.Put("/a/b/e/d/g/4", &discovery.KeyValue{Version: 4})
	...
	l, b := -1, false
	c.ForEach(func(k string, v *discovery.KeyValue) (next bool) {
		next = false
		l++
		return
	})
	...
	c.Put("/a/b/c/d/e/1", &discovery.KeyValue{Version: 2})
