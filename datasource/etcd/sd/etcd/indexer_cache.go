...
func (i *CacheIndexer) Search(ctx context.Context, opts ...registry.PluginOpOption) (*sd.Response, error) {
...
func NewCacheIndexer(cfg *sd.Config, c sd.Cache) *CacheIndexer {
	return &CacheIndexer{
