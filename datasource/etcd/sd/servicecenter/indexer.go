...
func (i *ClusterIndexer) Search(ctx context.Context, opts ...registry.PluginOpOption) (resp *sd.Response, err error) {
...
func (i *ClusterIndexer) search(ctx context.Context, opts ...registry.PluginOpOption) (r *sd.Response, err error) {
	op := registry.OpGet(opts...)
...
func (i *ClusterIndexer) searchSchemas(ctx context.Context, op registry.PluginOp) (*sd.Response, error) {
	var (
		resp  *sd.Response
		scErr *scerr.Error
	)
...
func (i *ClusterIndexer) searchInstances(ctx context.Context, op registry.PluginOp) (r *sd.Response, err error) {
	var (
		resp  *sd.Response
		scErr *scerr.Error
	)
