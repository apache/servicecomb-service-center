...
type mockCache struct {
	c map[string]*kvstore.KeyValue
}

func (n *mockCache) Name() string                   { return "mock" }
func (n *mockCache) Size() int                      { return 0 }
func (n *mockCache) Get(k string) *kvstore.KeyValue { return nil }
func (n *mockCache) GetAll(arr *[]*kvstore.KeyValue) (i int) {
	for range n.c {
		i++
	}
	return i
