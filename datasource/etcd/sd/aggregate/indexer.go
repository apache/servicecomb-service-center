...
func (i *AdaptorsIndexer) Search(ctx context.Context, opts ...registry.PluginOpOption) (*sd.Response, error) {
	var (
...
// Search implements sd.Indexer#Search.
func (i *AggregatorIndexer) Search(ctx context.Context, opts ...registry.PluginOpOption) (resp *sd.Response, err error) {
...
func (i *AggregatorIndexer) search(ctx context.Context, opts ...registry.PluginOpOption) (*sd.Response, error) {
