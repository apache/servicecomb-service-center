...
type Syncer struct {
	...
	cachers map[proto.Type]*Cacher
}

func (c *Syncer) Initialize() {
	c.cachers = make(map[proto.Type]*Cacher)
...
func (c *Syncer) checkWithConflictHandleFunc(local *Cacher, remote model.Getter, skipClusters map[string]error,
	...
	var deletes []*proto.KeyValue
	local.Cache().ForEach(func(key string, v *proto.KeyValue) (next bool) {
		var exist bool
...
// unsafe
func (c *Syncer) AddCacher(t proto.Type, cacher *Cacher) {
	c.cachers[t] = cacher
}
