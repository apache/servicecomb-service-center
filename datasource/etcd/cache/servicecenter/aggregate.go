...
func (c *SCClientAggregate) GetSchemasByServiceID(ctx context.Context, domainProject, serviceID string) (*cache.Response, *scerr.Error) {
	...
	for _, client := range *c {
		...
		for _, schema := range schemas {
			response.Kvs = append(response.Kvs, &cache.KeyValue{
...
func (c *SCClientAggregate) GetSchemaBySchemaID(ctx context.Context, domainProject, serviceID, schemaID string) (*cache.Response, *scerr.Error) {
	dp := strings.Split(domainProject, "/")
	var response cache.Response
	for _, client := range *c {
...
func (c *SCClientAggregate) GetInstancesByServiceID(ctx context.Context, domain, project, providerID, consumerID string) (*cache.Response, *scerr.Error) {
	var response cache.Response
	for _, client := range *c {
...
func (c *SCClientAggregate) GetInstanceByInstanceID(ctx context.Context, domain, project, providerID, instanceID, consumerID string) (*cache.Response, *scerr.Error) {
	var response cache.Response
	for _, client := range *c {
