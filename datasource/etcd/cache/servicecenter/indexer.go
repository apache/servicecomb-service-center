...
// ClusterIndexer implements pkg.Indexer.
...
func (i *ClusterIndexer) Search(ctx context.Context, opts ...registry.PluginOpOption) (resp *cache.Response, err error) {
...
func (i *ClusterIndexer) search(ctx context.Context, opts ...registry.PluginOpOption) (r *cache.Response, err error) {
	op := registry.OpGet(opts...)
...
func (i *ClusterIndexer) searchSchemas(ctx context.Context, op registry.PluginOp) (*cache.Response, error) {
	var (
		resp  *cache.Response
		scErr *scerr.Error
	)
...
func (i *ClusterIndexer) searchInstances(ctx context.Context, op registry.PluginOp) (r *cache.Response, err error) {
	var (
		resp  *cache.Response
		scErr *scerr.Error
	)
...
func NewClusterIndexer(t cache.Type, cache cache.Cache) *ClusterIndexer {
	return &ClusterIndexer{
		CacheIndexer: cache.NewCacheIndexer(cache),
