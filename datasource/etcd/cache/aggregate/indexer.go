...
// Search implements pkg.Indexer.Search.
...
func (i *AdaptorsIndexer) Search(ctx context.Context, opts ...registry.PluginOpOption) (*cache.Response, error) {
	var (
...
func NewAdaptorsIndexer(as []cache.Adaptor) *AdaptorsIndexer {
	return &AdaptorsIndexer{Adaptors: as}
}

// AggregatorIndexer implements pkg.Indexer.
...
type AggregatorIndexer struct {
	...
	*cache.CacheIndexer
	...
	AdaptorsIndexer cache.Indexer
	// LocalIndexer data from local adaptor.
	LocalIndexer cache.Indexer
}

// Search implements pkg.Indexer.Search.
func (i *AggregatorIndexer) Search(ctx context.Context, opts ...registry.PluginOpOption) (resp *cache.Response, err error) {
...
func (i *AggregatorIndexer) search(ctx context.Context, opts ...registry.PluginOpOption) (*cache.Response, error) {
...
func NewAggregatorIndexer(as *Aggregator) *AggregatorIndexer {
	...
	ai := &AggregatorIndexer{
		CacheIndexer:    cache.NewCacheIndexer(as.Cache()),
