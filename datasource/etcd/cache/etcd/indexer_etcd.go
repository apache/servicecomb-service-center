...
// Indexer implements pkg.Indexer.
...
func (i *Indexer) Search(ctx context.Context, opts ...registry.PluginOpOption) (r *cache.Response, err error) {
	...
	kvs := make([]*cache.KeyValue, 0, len(resp.Kvs))
