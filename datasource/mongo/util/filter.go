...
func ColDomain(domain string) Option {
	return func(filter bson.M) {
		filter[model.ColumnDomain] = domain
	}
}

func ColProject(project string) Option {
	return func(filter bson.M) {
...
func RefreshTime(time time.Time) Option {
	return func(filter bson.M) {
		filter[model.ColumnRefreshTime] = time
	}
}
...
func Pull(data interface{}) Option {
	return func(filter bson.M) {
		filter["$pull"] = data
	}
}

func AddToSet(data interface{}) Option {
	return func(filter bson.M) {
		filter["$addToSet"] = data
	}
}
...
func DepDependency(dependency interface{}) Option {
	return func(filter bson.M) {
		filter[ConnectWithDot([]string{model.ColumnDep, model.ColumnDependency})] = dependency
	}
}

func ServiceKey(serviceKey interface{}) Option {
	return func(filter bson.M) {
		filter[model.ColumnServiceKey] = serviceKey
	}
}
...
func ColSchema(schema string) Option {
	return func(filter bson.M) {
