...
import (
	...
	monoclonal "github.com/apache/servicecomb-service-center/datasource/mongo"
...
func getServiceFromDB(providerID string) *discovery.MicroService {
	...
	cfg.Timeout = "1s"
	service, errs := monoclonal.GetService(context.Background(), bson.M{"serviceinfo.serviceid": providerID})
